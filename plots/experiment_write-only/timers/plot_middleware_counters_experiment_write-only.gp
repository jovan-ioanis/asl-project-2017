...
plot 'throughput_write-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:5 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:8 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:11 with linespoints linestyle 7 title "64 WORKERS", \
'' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", \
'' using 1:5:($5-$6):($5+$6) with yerrorbars linestyle 4 title "", \
'' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 6 title "", \
'' using 1:11:($11-$12):($11+$12) with yerrorbars linestyle 8 title ""
...
plot 'throughput_write-only.csv' using 1:4 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:7 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:10 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:13 with linespoints linestyle 7 title "64 WORKERS"
