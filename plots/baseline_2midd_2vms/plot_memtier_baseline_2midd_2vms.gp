...
plot 'memtier_logs_baseline_2midd_2vmsWRITE-ONLY.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", \
...
plot 'memtier_logs_baseline_2midd_2vmsWRITE-ONLY.csv' using 1:4 with linespoints linestyle 1 title "8 WORKERS", \
