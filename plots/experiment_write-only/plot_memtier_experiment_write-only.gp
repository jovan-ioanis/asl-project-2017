...
plot 'memtier_logs_experiment_write-only_WRITE-ONLY.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", \
...
plot 'memtier_logs_experiment_write-only_WRITE-ONLY.csv' using 1:4 with linespoints linestyle 1 title "8 WORKERS", \
