...
set ylabel "Response Time at Middleware [ms]" font ",17" offset -0.3,0
set yrange [0:38]
...
set terminal pdf enhanced size 5,3
set output "RESPONSE_TIME_READ-ONLY.pdf"
plot 'response_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'response_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'response_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'response_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'response_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'response_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'response_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'response_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "NET-THREAD_PROCESSING_TIME_READ-ONLY.pdf"
plot 'netthread_processing_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'netthread_processing_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'netthread_processing_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'netthread_processing_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'netthread_processing_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'netthread_processing_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'netthread_processing_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'netthread_processing_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "WAIT-IN-QUEUE_TIME_READ-ONLY.pdf"
plot 'wait_in_queue_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'wait_in_queue_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'wait_in_queue_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'wait_in_queue_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'wait_in_queue_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'wait_in_queue_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'wait_in_queue_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'wait_in_queue_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "WORKER_PRE-PROCESSING_TIME_READ-ONLY.pdf"
plot 'worker_preprocessing_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'worker_preprocessing_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'worker_preprocessing_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'worker_preprocessing_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'worker_preprocessing_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'worker_preprocessing_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'worker_preprocessing_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'worker_preprocessing_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "SERVER_SERVICE_TIME_READ-ONLY.pdf"
plot 'server_service_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'server_service_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'server_service_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'server_service_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'server_service_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'server_service_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'server_service_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'server_service_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "WORKER_POST-PROCESSING_TIME_READ-ONLY.pdf"
plot 'worker_postprocessing_time_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'worker_postprocessing_time_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'worker_postprocessing_time_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'worker_postprocessing_time_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'worker_postprocessing_time_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'worker_postprocessing_time_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'worker_postprocessing_time_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'worker_postprocessing_time_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""
...
set terminal pdf enhanced size 5,3
set output "QUEUE_SIZE_READ-ONLY.pdf"
plot 'queue_size_read-only.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", 'queue_size_read-only.csv' using 1:4 with linespoints linestyle 3 title "16 WORKERS", 'queue_size_read-only.csv' using 1:6 with linespoints linestyle 5 title "32 WORKERS", 'queue_size_read-only.csv' using 1:8 with linespoints linestyle 7 title "64 WORKERS", 'queue_size_read-only.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'queue_size_read-only.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 4 title "", 'queue_size_read-only.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 6 title "", 'queue_size_read-only.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 8 title ""