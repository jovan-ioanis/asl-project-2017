...
set output "NETWORK_8WORKERS_READ-ONLY.pdf"
plot newhistogram "", 'dstat_memtier_wt8.csv' using 14:($14-$15):($14+$15):xtic(1) ls 1 title "memtier sent", \
newhistogram "", 'dstat_memcached_wt8.csv' using 10:($10-$11):($10+$11):xtic(1) ls 2 title "memcached received", \
newhistogram "", 'dstat_memcached_wt8.csv' using 14:($14-$15):($14+$15):xtic(1) ls 3 title "memcached sent", \
newhistogram "", 'dstat_memtier_wt8.csv' using 10:($10-$11):($10+$11):xtic(1) ls 4 title "memtier received"
...
set terminal pdf enhanced size 10,3.5
set output "NETWORK_16WORKERS_READ-ONLY.pdf"
plot newhistogram "", 'dstat_memtier_wt16.csv' using 14:($14-$15):($14+$15):xtic(1) ls 1 title "memtier sent", \
newhistogram "", 'dstat_memcached_wt16.csv' using 10:($10-$11):($10+$11):xtic(1) ls 2 title "memcached received", \
newhistogram "", 'dstat_memcached_wt16.csv' using 14:($14-$15):($14+$15):xtic(1) ls 3 title "memcached sent", \
newhistogram "", 'dstat_memtier_wt16.csv' using 10:($10-$11):($10+$11):xtic(1) ls 4 title "memtier received"
...
set terminal pdf enhanced size 10,3.5
set output "NETWORK_32WORKERS_READ-ONLY.pdf"
plot newhistogram "", 'dstat_memtier_wt32.csv' using 14:($14-$15):($14+$15):xtic(1) ls 1 title "memtier sent", \
newhistogram "", 'dstat_memcached_wt32.csv' using 10:($10-$11):($10+$11):xtic(1) ls 2 title "memcached received", \
newhistogram "", 'dstat_memcached_wt32.csv' using 14:($14-$15):($14+$15):xtic(1) ls 3 title "memcached sent", \
newhistogram "", 'dstat_memtier_wt32.csv' using 10:($10-$11):($10+$11):xtic(1) ls 4 title "memtier received"
...
set terminal pdf enhanced size 10,3.5
set output "NETWORK_64WORKERS_READ-ONLY.pdf"
plot newhistogram "", 'dstat_memtier_wt64.csv' using 14:($14-$15):($14+$15):xtic(1) ls 1 title "memtier sent", \
newhistogram "", 'dstat_memcached_wt64.csv' using 10:($10-$11):($10+$11):xtic(1) ls 2 title "memcached received", \
newhistogram "", 'dstat_memcached_wt64.csv' using 14:($14-$15):($14+$15):xtic(1) ls 3 title "memcached sent", \
newhistogram "", 'dstat_memtier_wt64.csv' using 10:($10-$11):($10+$11):xtic(1) ls 4 title "memtier received"
