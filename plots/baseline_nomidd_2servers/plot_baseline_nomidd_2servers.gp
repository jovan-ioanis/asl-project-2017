...
plot 'source_baseline_nomidd_2servers.csv' using 1:2 with linespoints linestyle 1 title "READ-ONLY", 'source_baseline_nomidd_2servers.csv' using 1:6 with linespoints linestyle 3 title "WRITE-ONLY", 'source_baseline_nomidd_2servers.csv' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", 'source_baseline_nomidd_2servers.csv' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 4 title ""
...
plot 'source_baseline_nomidd_2servers.csv' using 1:4 with linespoints linestyle 1 title "READ-ONLY", 'source_baseline_nomidd_2servers.csv' using 1:8 with linespoints linestyle 3 title "WRITE-ONLY", 'source_baseline_nomidd_2servers.csv' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 2 title "", 'source_baseline_nomidd_2servers.csv' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 4 title ""
