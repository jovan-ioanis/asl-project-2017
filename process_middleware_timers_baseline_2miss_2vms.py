...
agg_path_base = "aggregated_data/baseline_2midd_2vms/timers/"
...
def read_one_experiment(current_mw, client_thread, worker_thread, rep):
    command = "SET"
        ...
        for z, command_type in enumerate(command_types):
            ...
            for virtual_client in virtual_clients_pt:
                ...
                for worker_thread in worker_threads:
                    ...
                    a1, b1, c1, d1, e1, f1, g1, h1, i1 = read_one_experiment(current_mw, virtual_client, worker_thread, 0)
                    a2, b2, c2, d2, e2, f2, g2, h2, i2 = read_one_experiment(current_mw, virtual_client, worker_thread, 1)
                    a3, b3, c3, d3, e3, f3, g3, h3, i3 = read_one_experiment(current_mw, virtual_client, worker_thread, 2)
