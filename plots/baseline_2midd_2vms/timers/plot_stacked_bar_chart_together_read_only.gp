...
set xlabel "Number of Clients" font ",13" offset 0,-0.7
...
set key top horizontal reverse Left font ",13" spacing 1.7
set border 3 lw 4
set lmargin 13.0
set bmargin 4.0
#set bars 1.8
...
set terminal pdf enhanced size 13,4.5
set output "ALL_TIMES_TOGETHER_READ-ONLY.pdf"
plot  newhistogram "8 WORKERS", 'all_times_8workers_read_only.csv' \
...
newhistogram "16 WORKERS", 'all_times_16workers_read_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
'' using 6:xtic(1) ls 5 title "", \
newhistogram "32 WORKERS", 'all_times_32workers_read_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
'' using 6:xtic(1) ls 5 title "", \
newhistogram "64 WORKERS", 'all_times_64workers_read_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
