...
plots_base_name = "plots/baseline_2midd_2vms/"
file_base_name = "data/baseline_2midd_2vms/"
csv_file_name = "source_baseline_2midd_2vms.csv"
...
def assemble_and_print():
    ...
    for j in range(len(d)):
        if d[j] == "READ-ONLY":
            continue
        path = plots_base_name + "memtier_logs_baseline_2midd_2vms" + d[j] + ".csv"
