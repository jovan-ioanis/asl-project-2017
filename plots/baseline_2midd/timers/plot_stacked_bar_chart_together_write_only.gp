...
plot  newhistogram "8 WORKERS", 'all_times_8workers_write_only.csv' \
...
newhistogram "16 WORKERS", 'all_times_16workers_write_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
'' using 6:xtic(1) ls 5 title "", \
newhistogram "32 WORKERS", 'all_times_32workers_write_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
'' using 6:xtic(1) ls 5 title "", \
newhistogram "64 WORKERS", 'all_times_64workers_write_only.csv' \
   using 2 ls 1 title "", \
'' using 3 ls 2 title "", \
'' using 4 ls 3 title "", \
'' using 5 ls 4 title "", \
