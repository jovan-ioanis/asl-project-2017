...
plot 'memtier_logs_baseline_2midd_WRITE-ONLY.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:6 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:10 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:14 with linespoints linestyle 7 title "64 WORKERS", \
'' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", \
'' using 1:6:($6-$7):($6+$7) with yerrorbars linestyle 4 title "", \
'' using 1:10:($10-$11):($10+$11) with yerrorbars linestyle 6 title "", \
'' using 1:14:($14-$15):($14+$15) with yerrorbars linestyle 8 title ""
...
plot 'memtier_logs_baseline_2midd_READ-ONLY.csv' using 1:2 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:6 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:10 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:14 with linespoints linestyle 7 title "64 WORKERS", \
'' using 1:2:($2-$3):($2+$3) with yerrorbars linestyle 2 title "", \
...
plot 'memtier_logs_baseline_2midd_WRITE-ONLY.csv' using 1:4 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:8 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:12 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:16 with linespoints linestyle 7 title "64 WORKERS", \
'' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 2 title "", \
'' using 1:8:($8-$9):($8+$9) with yerrorbars linestyle 4 title "", \
'' using 1:12:($12-$13):($12+$13) with yerrorbars linestyle 6 title "", \
'' using 1:16:($16-$17):($16+$17) with yerrorbars linestyle 8 title ""
...
plot 'memtier_logs_baseline_2midd_READ-ONLY.csv' using 1:4 with linespoints linestyle 1 title "8 WORKERS", \
'' using 1:8 with linespoints linestyle 3 title "16 WORKERS", \
'' using 1:12 with linespoints linestyle 5 title "32 WORKERS", \
'' using 1:16 with linespoints linestyle 7 title "64 WORKERS", \
'' using 1:4:($4-$5):($4+$5) with yerrorbars linestyle 2 title "", \
